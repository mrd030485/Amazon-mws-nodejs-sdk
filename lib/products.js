...
module.exports = {
    ...
    ListMatchingProducts: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'Query')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId and Query"});
        }
    ...
    GetMatchingProduct: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'ASINList')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId and ASINList"});
        }
        ...
        var asinListNum = 1;
        _.each(params['ASINList'], function(ASIN){
            if(asinListNum <= 10){
                parameters['ASINList.ASIN.'+asinListNum] = ASIN;
            }else{
                console.log("#"+asinListNum.toString()+" is over the limit");
            }
        });
        mws.createRequest({
    ...
    GetMatchingProductForId: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'IdType') || !_.has(params, 'IdList')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId, IdType and IdList"});
        }
        ...
        if (params['IdType'] !== 'ASIN' && params['IdType'] !== 'GCID' && params['IdType'] !== 'SellerSKU' && params['IdType'] !== 'UPC' && params['IdType'] !== 'EAN' && params['IdType'] !== 'JAN' && params['IdType'] !== 'ISBN') {
            defer.reject({'Error': "Usage of unallowed IdType. Allowed are ASIN,GCID,SellerSKU,UPC,EAN,ISBN,JAN"});
        }
        ...
        var idListNum = 1;
        _.each(params['IdList'], function(Id){
            parameters['IdList.Id.'+idListNum] = Id;
        });
        mws.createRequest({
    ...
    GetCompetitivePricingForSKU: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'SellerSKUList')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId and SellerSKUList"});
        }
        ...
        var sellerSKUNum = 1;
        _.each(params['SellerSKUList'], function(SellerSKU){
            if(sellerSKUNum <= 20){
                parameters['SellerSKUList.SellerSKU.'+sellerSKUNum] = SellerSKU;
            }else{
                console.log("#"+sellerSKUNum.toString()+" is over the limit");
            }
        });
        mws.createRequest({
    ...
    GetLowestOfferListingsForSKU: function (config, params, xml, cb) {
        ...
        if (_.has(params, 'ItemCondition') && !_.contains(this.ItemCondition, params['ItemCondition'])) {
            defer.reject({"Error": "ItemCondition is not valid type. Check documentation for valid ItemCondition types"});
        }
        else {
    ...
    GetProductCategoriesForSKU: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'SellerSKU')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId and SellerSKU"});
        }
        var parameters = {
            'MarketplaceId': params['MarketplaceId'],
    ...
    GetProductCategoriesForASIN: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'ASIN')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId and ASIN"});
        }
        var parameters = {
            'MarketplaceId': params['MarketplaceId'],
            'ASIN': params['ASIN']
    ...
    GetLowestPricedOffersForSKU: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'SellerSKU') || !_.has('ItemCondition')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId,ItemCondition and SellerSKU"});
        }
        var parameters = {
            "MarketplaceId": params['MarketplaceId'],
            "SellerSKU": params['SellerSKU']
    ...
    GetLowestPricedOffersForASIN: function (config, params, xml, cb) {
        ...
        if (!_.has(params, 'MarketplaceId') || !_.has(params, 'ASIN') || !_.has(params, 'ItemCondition')) {
            defer.reject({"Error": "You need to pass parameter MarketplaceId,ItemCondition and ASIN"});
        }
        var parameters = {
            "MarketplaceId": params['MarketplaceId'],
            "ASIN": params['ASIN']
